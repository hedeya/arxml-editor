@echo off
echo ========================================
echo ARXML Editor - Simple PyQt6 Build
echo ========================================
echo.
echo This script uses a simpler approach to avoid PyQt6 DLL issues.
echo.
pause
...
REM Build the executable with simpler PyQt6 handling
echo Building Windows executable...
python -m PyInstaller --clean --onefile --windowed --name ARXML_Editor ^
    ...
    --collect-data PyQt6 ^
    --copy-metadata PyQt6 ^
    --paths "C:\Program Files\Python314\Lib\site-packages" ^
    --paths "C:\Users\%USERNAME%\AppData\Roaming\Python\Python314\site-packages" ^
    main.py
