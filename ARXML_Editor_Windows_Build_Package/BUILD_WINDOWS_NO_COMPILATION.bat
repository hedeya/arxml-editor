@echo off
echo ========================================
echo ARXML Editor - No Compilation Build
echo ========================================
echo.
echo This script uses only packages with pre-compiled wheels
echo and replaces lxml with standard library XML parser.
echo.
pause
