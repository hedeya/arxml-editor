...
echo ========================================
echo.
echo This script will build a proper Windows executable
echo for the ARXML Editor with PyQt6 support.
echo.
echo IMPORTANT: The provided executable in the release
echo is actually a Linux binary and will not run on Windows.
echo You must build it yourself using this script.
echo.
pause
