#!/usr/bin/env python3
"""
ARXML Editor - Tkinter Version (Fixed)
Main entry point for the Tkinter-based ARXML Editor with better error handling
"""
...
print("=" * 60)
print("ARXML Editor - Tkinter Version (Fixed)")
print("=" * 60)
...
try:
    ...
    print("Attempting to import fixed main window...")
    from src.ui.tkinter_main_window_fixed import main
    print("✓ Fixed main window imported successfully")
