@echo off
echo ========================================
echo ARXML Editor - PyQt6 Fix Build
echo ========================================
echo.
echo This script tries to fix PyQt6 DLL issues by using a different approach.
echo.
pause
...
REM Uninstall existing PyQt6 and reinstall with specific method
echo Uninstalling existing PyQt6...
pip uninstall PyQt6 PyQt6-Qt6 PyQt6-sip -y

REM Install PyQt6 with specific method to avoid DLL issues
echo Installing PyQt6 with specific method...
pip install --no-cache-dir --force-reinstall PyQt6==6.6.1
if errorlevel 1 (
...
REM Test PyQt6 import first
echo Testing PyQt6 import...
python -c "from PyQt6.QtCore import Qt; print('PyQt6 import successful')"
if errorlevel 1 (
    echo ERROR: PyQt6 import failed. Cannot proceed with build.
    echo This indicates a fundamental PyQt6 installation issue.
    pause
    exit /b 1
)

REM Build the executable with minimal PyQt6 handling
